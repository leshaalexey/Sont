...
/// * 6 — убрана настройка «попыток до смены сервера». Демон больше не
///   перебирает серверы вслепую: он различает отказ сервера и отказ машины,
///   и бюджету попыток стало нечем управлять.
