...
///
/// Секунда, а не три. Пока агента нет рядом с демоном, системный прокси не
/// объявлен, то есть в режиме прокси пользователь сидит без сети — и эта пауза
/// целиком уходит в его ожидание. Попытка подключения к локальному сокету не
/// стоит ничего.
